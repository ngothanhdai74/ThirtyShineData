...
namespace S4M.Database
{
    public partial class S4MContext : DbContext
    {
        public S4MContext()
        {
        }

        public S4MContext(DbContextOptions<S4MContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<StatisticRevenueNew20200229> StatisticRevenueNew20200229 { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=10.0.2.76;Initial Catalog=S4M;Persist Security Info=True;User ID=ad_30s;Password=VDrs8XHyz3Rdc7PAiv5Q");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BillService>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.CreatedDate, e.IsDelete, e.SalonId, e.Pending, e.Id })
                    .HasName("_dta_index_BillService_11_1930742628__K21_K1_8_13_18");

                entity.HasIndex(e => new { e.Id, e.BookingId, e.SalonId, e.Pending, e.CompleteBillTime })
                    .HasName("IDX_5696_5695_Solution_30shinedboBillService");
                ...
                entity.HasIndex(e => new { e.Id, e.StaffHairdresserId, e.IsDelete, e.Pending, e.SalonId })
                    .HasName("_dta_index_BillService_11_1930742628__K1_K3_K13_K21_K18");
            ...
            modelBuilder.Entity<BillServiceHis>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.SalonId, e.IsDelete, e.Pending, e.BillCode, e.CompleteBillTime })
                    .HasName("IDX_122_121_Solution_30shinedboBillServiceHis");
            ...
            modelBuilder.Entity<BillTagHis>(entity =>
            {
                entity.HasIndex(e => e.BillId)
                    .HasName("IDX_15689_15688_Solution_30shinedboBillTagHis");
            ...
            modelBuilder.Entity<BookHour>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Publish, e.IsDelete, e.SalonId, e.HourFrame })
                    .HasName("IDX_74_73_Solution_30shinedboBookHour");
            ...
            modelBuilder.Entity<BookHour2ndSub>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.HourFrame, e.SecondSubHourId })
                    .HasName("IDX_145046_145045_Solution_30shinedboBookHour_2ndSub");

                entity.HasIndex(e => new { e.Id, e.HourFrame, e.SubHourId })
                    .HasName("IDX_152491_152490_Solution_30shinedboBookHour_2ndSub");

                entity.HasIndex(e => new { e.Id, e.HourId, e.SubHourId, e.SecondSubHourId, e.Hour, e.HourFrame, e.CreatedDate, e.ModifiedDate, e.SalonId, e.Publish, e.IsDelete })
                    .HasName("IDX_163157_163156_Solution_30shinedboBookHour_2ndSub");
            ...
            modelBuilder.Entity<BookHourSub>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.HourId, e.SubHourId, e.Hour, e.HourFrame, e.CreatedDate, e.ModifiedDate, e.SalonId, e.Publish, e.IsDelete })
                    .HasName("IDX_163141_163140_Solution_30shinedboBookHour_Sub");

                entity.HasIndex(e => new { e.Id, e.HourId, e.SubHourId, e.Hour, e.HourFrame, e.Publish, e.CreatedDate, e.ModifiedDate, e.SalonId, e.IsDelete })
                    .HasName("IDX_163219_163218_Solution_30shinedboBookHour_Sub");
            ...
            modelBuilder.Entity<Booking>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.IsDelete, e.CustomerId, e.DatedBook })
                    .HasName("IDX_86793_86792_Solution_30shinedboBooking");

                entity.HasIndex(e => new { e.CustomerName, e.CustomerPhone, e.CustomerScore, e.SubHour, e.CustomerId, e.CampaignId, e.SalonNote, e.TimeSalonNote, e.BookingStatusId, e.Uid, e.MigrateStatus, e.IsArrived, e.CancelBookSmsstatus, e.CancelBookFrom, e.IsAutoStylist, e.IsSetAutoStylist, e.TextNote1, e.TextNote2, e.AuthOtpTimeReceived, e.TheadId, e.Version, e.SuggestSalonId, e.CancelBookIsSendSms, e.CancelBookTimeSend, e.AuthOtpIsSet, e.AuthOtpIsVerified, e.AuthOtpToken, e.AuthOtpTimeSend, e.AuthOtpTimeVerified, e.AuthOtpSmsstatus, e.BookingTempId, e.IsBookOnline, e.IsBookStylist, e.SmsnotiIsSend, e.SmsnotiSendTime, e.SmsnotiStatus, e.NewCustomer, e.NoteDelete, e.IsBookAtSalon, e.Macaddress, e.IsLimited, e.TokenClient, e.IsMakeBill, e.FlowTimeKeepingId, e.IsSms, e.Smsstatus, e.SendDate, e.Os, e.HourId, e.CreatedDate, e.ModifiedDate, e.StylistId, e.UserId, e.Note, e.SalonId, e.IsDelete, e.DatedBook, e.Id })
                ...
                entity.HasIndex(e => new { e.Id, e.CustomerName, e.CampaignId, e.IsEnterVoucher, e.IsUseVoucher, e.PublicIp, e.PrivateIp, e.IsArrived, e.CustomerScore, e.CustomerId, e.IsCall, e.IsCallTime, e.IsCallTimeModified, e.TextNote2, e.SalonNote, e.TimeSalonNote, e.BookingStatusId, e.Uid, e.MigrateStatus, e.CancelBookTimeSend, e.CancelBookSmsstatus, e.CancelBookFrom, e.IsAutoStylist, e.IsSetAutoStylist, e.TextNote1, e.AuthOtpSmsstatus, e.AuthOtpTimeReceived, e.TheadId, e.Version, e.SuggestSalonId, e.CancelBookIsSendSms, e.SmsnotiStatus, e.AuthOtpIsSet, e.AuthOtpIsVerified, e.AuthOtpToken, e.AuthOtpTimeSend, e.AuthOtpTimeVerified, e.TokenClient, e.BookingTempId, e.IsBookOnline, e.IsBookStylist, e.SmsnotiIsSend, e.SmsnotiSendTime, e.SendDate, e.NewCustomer, e.NoteDelete, e.IsBookAtSalon, e.Macaddress, e.IsLimited, e.UserId, e.Note, e.IsMakeBill, e.FlowTimeKeepingId, e.IsSms, e.Smsstatus, e.CustomerPhone, e.HourId, e.CreatedDate, e.ModifiedDate, e.SalonId, e.StylistId, e.IsDelete, e.DatedBook, e.SubHour, e.Os })
                    .HasName("IDX_8880_8879_Solution_30shinedboBooking");

                entity.HasIndex(e => new { e.Id, e.CustomerName, e.CustomerPhone, e.HourId, e.CreatedDate, e.CampaignId, e.IsEnterVoucher, e.IsUseVoucher, e.PublicIp, e.PrivateIp, e.CustomerScore, e.SubHour, e.CustomerId, e.IsCall, e.IsCallTime, e.IsCallTimeModified, e.SalonNote, e.TimeSalonNote, e.BookingStatusId, e.Uid, e.MigrateStatus, e.IsArrived, e.CancelBookSmsstatus, e.CancelBookFrom, e.IsAutoStylist, e.IsSetAutoStylist, e.TextNote1, e.TextNote2, e.AuthOtpTimeReceived, e.TheadId, e.Version, e.SuggestSalonId, e.CancelBookIsSendSms, e.CancelBookTimeSend, e.AuthOtpIsSet, e.AuthOtpIsVerified, e.AuthOtpToken, e.AuthOtpTimeSend, e.AuthOtpTimeVerified, e.AuthOtpSmsstatus, e.BookingTempId, e.IsBookOnline, e.IsBookStylist, e.SmsnotiIsSend, e.SmsnotiSendTime, e.SmsnotiStatus, e.NewCustomer, e.NoteDelete, e.IsBookAtSalon, e.Macaddress, e.IsLimited, e.TokenClient, e.IsMakeBill, e.FlowTimeKeepingId, e.IsSms, e.Smsstatus, e.SendDate, e.Os, e.ModifiedDate, e.IsDelete, e.SalonId, e.StylistId, e.UserId, e.Note, e.DatedBook })
                ...
                entity.Property(e => e.ChosenServices).HasMaxLength(500);
            ...
            {
                entity.HasIndex(e => new { e.Id, e.CreateTime, e.DeleteTime, e.IsAutoGenerate, e.UpdateTime, e.Length, e.IsDelete, e.Uid, e.MigrateStatus, e.Salon, e.EndTime, e.Receiver, e.SenderId, e.ReceiverId, e.Seq, e.Sender, e.SalonId, e.StartTime, e.Status })
                    .HasName("IDX_20180715_98_97_Solution_30shinedboCall");

                entity.HasIndex(e => new { e.DeleteTime, e.EndTime, e.Receiver, e.SenderId, e.ReceiverId, e.Uid, e.Salon, e.SubStatus, e.Note, e.PreviousStatus, e.Seq, e.Sender, e.StartTime, e.Status, e.UpdateTime, e.Length, e.MigrateStatus, e.SalonId, e.CreateTime, e.IsAutoGenerate, e.IsDelete, e.Id, e.Type })
                    .HasName("_dta_index_Call_9_1199467584__K16_K18_K2_K19_K14_K1_K20_3_4_5_6_7_8_9_10_11_12_13_15_17_21_22_23");

                entity.HasIndex(e => new { e.Id, e.DeleteTime, e.EndTime, e.SenderId, e.ReceiverId, e.Seq, e.Sender, e.StartTime, e.Status, e.UpdateTime, e.Length, e.Uid, e.MigrateStatus, e.Salon, e.SalonId, e.IsAutoGenerate, e.Type, e.Note, e.PreviousStatus, e.IsDelete, e.CreateTime, e.Receiver, e.SubStatus })
                    .HasName("_dta_index_Call_11_423261260__K14_K2_K5_K21_1_3_4_6_7_8_9_10_11_12_13_15_16_17_18_19_20_22_23");

                entity.HasIndex(e => new { e.Id, e.DeleteTime, e.EndTime, e.SenderId, e.ReceiverId, e.Seq, e.Sender, e.StartTime, e.Status, e.UpdateTime, e.Length, e.Uid, e.MigrateStatus, e.Salon, e.SalonId, e.IsAutoGenerate, e.Type, e.SubStatus, e.Note, e.PreviousStatus, e.Receiver, e.IsDelete, e.CreateTime })
                    .HasName("IDX_755293_755292_Solution_30shinedboCall");
            ...
            modelBuilder.Entity<CrmVoucherWaitTime>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.CustomerId, e.IsUsed, e.IsDelete })
                    .HasName("IDX_85097_85096_Solution_30shinedboCRM_VoucherWaitTime");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasIndex(e => e.Id)
                    .HasName("_dta_index_Customer_10_20075053__K1");
                ...
                entity.HasIndex(e => new { e.Id, e.Fullname, e.Phone, e.Email, e.SnDay, e.SnMonth, e.SnYear, e.Age, e.CustomerCode, e.InfoFlow, e.CreatedDate, e.CityId, e.DistrictId, e.Publish, e.ModifiedDate, e.SalonId, e.FingerTemplate, e.FingerToken, e.FingerTemplateBn, e.IsAppointment, e.CustomerCode1, e.DeleteByDuplicate, e.IsNoInfor, e.Password, e.AccessToken, e.IsOld, e.FacebookId, e.Avatar, e.TotalPoint, e.IsSms, e.GoogleId, e.CheckCode, e.ThreadId, e.Veryfied, e.ChatbotFacebookId, e.TotalMoneyBillservice, e.TotalBillservice, e.Otp, e.Uid, e.MigrateStatus, e.St1, e.St2, e.Salon1, e.Score, e.DateLastBillService, e.MemberStartTime, e.MemberEndTime, e.MemberProductId, e.Occupation, e.WardId, e.LastBillId, e.Salon2, e.MemberType, e.IsDelete })
                    .HasName("_dta_index_Customer_11_20075053__K46_K49_K16_1_2_3_4_5_6_7_8_10_11_12_13_14_15_17_18_19_20_21_22_23_24_25_26_27_28_29_30_31_32_");
                ...
                entity.Property(e => e.FingerTemplate).HasColumnType("nvarchar(max)");

                entity.Property(e => e.FingerTemplateBn).HasColumnType("varbinary(max)");
            ...
            modelBuilder.Entity<CustomerHairModeBill>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.BillId, e.IsDelete, e.HairStyleId })
                    .HasName("IDX_182_181_Solution_30shinedboCustomer_HairMode_Bill");

                entity.HasIndex(e => new { e.Id, e.BillId, e.CreateDate, e.HairStyleId, e.IsDelete })
                    .HasName("_dta_index_Customer_HairMode_Bill_11_143599850__K5D_K3_K6_1_4");
            ...
            modelBuilder.Entity<CustomerToken>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Imei, e.CustomerPhone, e.CreatedDate, e.ModifiedDate, e.CustomerId, e.IsDelete, e.Token, e.Id })
                    .HasName("_dta_index_CustomerToken_10_486493409__K7_K3_K1_2_4_5_6_8");
            ...
            modelBuilder.Entity<FlowProduct>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.BillId, e.ProductId, e.Price, e.Quantity, e.VoucherPercent, e.PromotionMoney, e.ComboId, e.IsDelete })
                    .HasName("IDX_22314_22313_Solution_30shinedboFlowProduct");
...
| 1 : Dịch vụ (Cạo mặt, Lấy ráy tai...) |");
            ...
            {
                entity.HasIndex(e => new { e.CreatedDate, e.IsDelete, e.ServiceId })
                    .HasName("_dta_index_FlowService_10_87260063__K5_K6_K3");
                ...
                entity.HasIndex(e => new { e.Id, e.BillId, e.ServiceId, e.Price, e.Uid, e.MigrateStatus, e.Quantity, e.ModifiedDate, e.SalonId, e.SellerId, e.VoucherPercent, e.CoefficientRating, e.IsDelete, e.CreatedDate })
                    .HasName("IDX_20180715_80038_80037_Solution_30shinedboFlowService");

                entity.HasIndex(e => new { e.Id, e.BillId, e.ServiceId, e.Uid, e.MigrateStatus, e.Price, e.Quantity, e.ModifiedDate, e.SellerId, e.VoucherPercent, e.CoefficientRating, e.IsDelete, e.SalonId, e.CreatedDate })
            ...
            {
                entity.HasIndex(e => new { e.Type, e.StaffId, e.IsDelete })
                    .HasName("IDX_18344_18343_Solution_30shinedboIvInventory");
            ...
            {
                entity.HasIndex(e => new { e.Id, e.ProductId, e.InvMaxDay, e.InvMaxOld, e.InvMaxSugges, e.InvMaxUser, e.InventoryId, e.IsDelete, e.CreatedDate })
                    .HasName("IDX_340_339_Solution_30shinedboIvInventoryControl");
            ...
            {
                entity.HasIndex(e => new { e.InventoryId, e.IsDelete })
                    .HasName("IDX_85154_85153_Solution_30shinedboIvInventoryCurrent");

                entity.HasIndex(e => new { e.InventoryId, e.AccountingDate, e.IsDelete })
                    .HasName("IDX_4002_4001_Solution_30shinedboIvInventoryCurrent");

                entity.HasIndex(e => new { e.InventoryId, e.Begin, e.Import, e.Export, e.SellOrUse, e.UsedInService, e.ProductId, e.IsDelete })
                    .HasName("IDX_85134_85133_Solution_30shinedboIvInventoryCurrent");
            ...
            {
                entity.HasIndex(e => new { e.ProductId, e.Cost, e.Begin, e.Import, e.Export, e.SellOrUse, e.UsedInService, e.ExportToStaff, e.ExportToMainWh, e.ExportToSalon, e.ImportFromPartner, e.ImportFromSalon, e.ImportFromStaff, e.ImportFromReturn, e.ImportFromMainWh, e.UsedEnd, e.ImportFromCompensation, e.SellAfterCheck, e.InventoryId, e.IsDelete, e.AccountingDate })
                    .HasName("IDX_215_214_Solution_30shinedboIvInventoryHistory");
            ...
            {
                entity.HasIndex(e => new { e.Id, e.ProductId, e.InvMaxDay, e.InvMaxOld, e.InvMaxSugges, e.InvMaxUser, e.InventoryId, e.IsDelete, e.CreatedDate })
                    .HasName("IDX_292_291_Solution_30shinedboIvInventoryMaxService");
            ...
            {
                entity.HasIndex(e => new { e.Id, e.ProductId, e.MaxInventoryOld, e.MaxInventorySugges, e.MaxSellLastPeriod, e.MaxInventoryUserInput, e.InventoryId, e.IsDelete, e.Date })
                    .HasName("IDX_745613_745612_Solution_30shinedboIvMaxProductInventoryNorms");
            ...
            {
                entity.HasIndex(e => new { e.Id, e.Code, e.InventoryPartnerId, e.Note, e.OrderType, e.Status, e.IsAuto, e.CosmeticType, e.CreatedDate, e.ReviewedDate, e.ReceivedDate, e.IsPrint, e.InventoryOrderId, e.IsDelete })
                    .HasName("IDX_2802_2801_Solution_30shinedboIvOrder");
            ...
            modelBuilder.Entity<IvOrderDetail>(entity =>
            {
                entity.HasIndex(e => new { e.OrderId, e.IsDelete })
                    .HasName("IDX_84995_84994_Solution_30shinedboIvOrderDetail");
            ...
            modelBuilder.Entity<Message>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Status, e.SalonId, e.SendTime, e.IsDelete, e.Id, e.Receiver })
                    .HasName("_dta_index_Message_9_1231467698__K10_K19_K13_K14_K1_K11");
                ...
                entity.HasIndex(e => new { e.Id, e.CreateTime, e.DeleteTime, e.Salon, e.Type, e.Receiver, e.UpdateTime, e.IsDelete, e.Uid, e.MigrateStatus, e.SendSuccessTime, e.SenderId, e.ReceiverId, e.Text, e.Seq, e.Sender, e.Status, e.IsAutoGenerate, e.SalonId, e.SendTime })
                    .HasName("IDX_20180715_84_83_Solution_30shinedboMessage");

                entity.HasIndex(e => new { e.Id, e.CreateTime, e.DeleteTime, e.SenderId, e.ReceiverId, e.Salon, e.Type, e.UpdateTime, e.SendTime, e.IsDelete, e.Uid, e.MigrateStatus, e.SendSuccessTime, e.IsAutoGenerate, e.Text, e.Seq, e.Sender, e.Status, e.Receiver, e.SalonId })
                    .HasName("IDX_20180715_16929_16928_Solution_30shinedboMessage");

                entity.HasIndex(e => new { e.Id, e.CreateTime, e.DeleteTime, e.SenderId, e.Salon, e.Type, e.UpdateTime, e.SendTime, e.IsDelete, e.Uid, e.MigrateStatus, e.SendSuccessTime, e.ReceiverId, e.IsAutoGenerate, e.Text, e.Seq, e.Sender, e.Receiver, e.SalonId, e.Status })
            ...
            {
                entity.HasIndex(e => new { e.MoneyDeductions, e.BillId })
                    .HasName("IDX_90_89_Solution_30shinedboMktCampaignBill");
            ...
            {
                entity.HasIndex(e => new { e.Code, e.IsDelete, e.IsActive })
                    .HasName("IDX_298_297_Solution_30shinedboMktVoucher");
            ...
            modelBuilder.Entity<MonitorStaffError>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.StaffId, e.CategoryRootId, e.StatusError, e.IsDelete, e.ErrorTime })
                    .HasName("IDX_458_457_Solution_30shinedboMonitorStaffError");

                entity.HasIndex(e => new { e.CategorySubId, e.StaffId, e.CategoryRootId, e.StatusError, e.IsDelete, e.ErrorTime })
                    .HasName("IDX_8_7_Solution_30shinedboMonitorStaffError");
            ...
            {
                entity.HasIndex(e => new { e.OrderBrokenDeviceId, e.TypeId })
                    .HasName("IDX_346_345_Solution_30shinedboOrderBrokenDeviceHandlingLog");
            ...
            modelBuilder.Entity<PermissionMenu>(entity =>
            {
                entity.HasIndex(e => new { e.Pid, e.Id })
                    .HasName("IDX_11864_11863_Solution_30shinedboPermissionMenu");

                entity.HasIndex(e => new { e.PageId, e.IsDelete, e.IsActive })
                    .HasName("IDX_11861_11860_Solution_30shinedboPermissionMenu");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.Name, e.Publish, e.IsDelete, e.InventoryType })
                    .HasName("IDX_124_123_Solution_30shinedboProduct");
            ...
            {
                entity.HasIndex(e => new { e.SalonReceiveId, e.CreatedDate })
                    .HasName("IDX_78149_78148_Solution_30shinedboProductReturn");
            ...
            modelBuilder.Entity<QlkhoSalonOrder>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.BillCode, e.CreatedTime, e.ModifiedTime, e.IsDelete, e.StatusId, e.NoteSalon, e.NoteKho, e.ProductIds, e.ExportTime, e.ReceivedTime, e.Order, e.Uid, e.MigrateStatus, e.SalonId, e.OrderDate, e.CheckCosmetic })
                    .HasName("IDX_163236_163235_Solution_30shinedboQLKho_SalonOrder");
            ...
            {
                entity.HasIndex(e => new { e.TenQuanHuyen, e.Id })
                    .HasName("_dta_index_QuanHuyen_11_245575913__K1_3");
            ...
            modelBuilder.Entity<SalaryIncome>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.StaffId, e.SalonId, e.FixedSalary, e.AllowanceSalary, e.OvertimeSalary, e.ServiceSalary, e.ProductSalary, e.BehaveSalary, e.RatingPoint, e.BillNormal, e.BillNormalGreat, e.BillNormalGood, e.BillNormalBad, e.BillNormalNoRating, e.BillSpecial, e.BillSpecialGreat, e.BillSpecialGood, e.BillSpecialBad, e.BillSpecialNoRating, e.Month, e.Year, e.TotalIncome, e.GrandTotalIncome, e.CreatedTime, e.ModifiedTime, e.IsDeleted, e.Uid, e.MigrateStatus, e.LevelId, e.Kpisalary, e.TempSalary, e.WorkDate })
                    .HasName("IDX_46633_46632_Solution_30shinedboSalaryIncome");
            ...
            {
                entity.HasIndex(e => new { e.InventoryId, e.ProductId, e.IsUse })
                    .HasName("IDX_338_337_Solution_30shinedboSalonProduct");

                entity.HasIndex(e => new { e.ProductId, e.SalonId, e.IsUse })
                    .HasName("IDX_282_281_Solution_30shinedboSalonProduct");

                entity.HasIndex(e => new { e.InventoryId, e.ProductId, e.IsUse, e.IsFrezze })
                    .HasName("IDX_472_471_Solution_30shinedboSalonProduct");

                entity.HasIndex(e => new { e.Id, e.SalonId, e.ProductId, e.InventoryType, e.IsUse, e.Price, e.Discount, e.InventoryId, e.IsFrezze })
                    .HasName("IDX_4004_4003_Solution_30shinedboSalonProduct");
            ...
            modelBuilder.Entity<ScscCheckError>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.BillServiceId, e.ImageError, e.ShapeId, e.ConnectTiveId, e.SharpNessId, e.ComPlatetionId, e.PointError, e.HairTipId, e.HairRootId, e.HairWavesId, e.TotalPointScsccurling, e.ImageErrorCurling, e.IsDelete })
                    .HasName("IDX_18776_18775_Solution_30shinedboSCSC_CheckError");

                entity.HasIndex(e => new { e.ImageError, e.NoteError, e.ShapeId, e.ConnectTiveId, e.SharpNessId, e.ComPlatetionId, e.TotalPointScsc, e.HairTipId, e.HairRootId, e.HairWavesId, e.TotalPointScsccurling, e.ImageErrorCurling, e.BillServiceId, e.Id })
            ...
            {
                entity.HasIndex(e => new { e.SalonId, e.CutErrorDate })
                    .HasName("IDX_563_562_Solution_30shinedboSpecialCusDetail");

                entity.HasIndex(e => new { e.CutErrorDate, e.IsDelete, e.QuantityInvited })
                    .HasName("IDX_416_415_Solution_30shinedboSpecialCusDetail");
            ...
            {
                entity.HasIndex(e => new { e.CustomerId, e.CustomerTypeId, e.IsDelete })
                    .HasName("IDX_4332_4331_Solution_30shinedboSpecialCustomer");
            ...
            modelBuilder.Entity<Staff>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.Fullname, e.Active, e.IsDelete, e.Type })
                    .HasName("IDX_145371_145370_Solution_30shinedboStaff");
            ...
            modelBuilder.Entity<StaffBillServiceDetail>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.BillId, e.ServiceId, e.ServiceBonus, e.BillSalonId, e.ServiceIncomeBonus, e.IsDelete, e.ModifyTime, e.CreateTime, e.Quantity, e.ConventionPoint, e.StaffLevelId, e.OvertimeStatusValue, e.RatingMark, e.RatingMoney, e.SalaryCoeficient, e.ServiceCoeficient, e.DepartmentId, e.StaffId, e.WorkDate })
            ...
            {
                entity.HasIndex(e => new { e.ContractId, e.ContractDate, e.Active, e.StaffId })
                    .HasName("IDX_31_30_Solution_30shinedboStaffContractMap");
            ...
            modelBuilder.Entity<StatisticRevenueNew20200229>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("StatisticRevenue_new20200229");
...
")
            ...
            modelBuilder.Entity<StynextBill>(entity =>
            {
                ...
                entity.HasIndex(e => e.BillId)
                    .HasName("IDX_92640_92639_Solution_30shinedboStynextBill");

                entity.HasIndex(e => e.Id)
                    .HasName("IDX_23916_23915_Solution_30shinedboStynextBill");

                entity.HasIndex(e => new { e.IsDeleted, e.CustomerId, e.BillId, e.BillDate })
                    .HasName("IDX_24582_24581_Solution_30shinedboStynextBill");

                entity.HasIndex(e => new { e.Id, e.BillId, e.StylistId, e.SkinnerId, e.StynextGroupId, e.GroupLeaderId, e.CreatedTime, e.ModifiedTime, e.CustomerId, e.ReturnDate, e.ReturnAfterDays, e.IsGuaranteed, e.SalonId, e.IsDeleted, e.BillDate })
                    .HasName("IDX_24580_24579_Solution_30shinedboStynextBill");
            ...
            modelBuilder.Entity<TblSalon>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.IsDelete, e.IsSalonHoiQuan, e.Publish })
                    .HasName("_dta_index_Tbl_Salon_11_1069558123__K15_K25_K14");
                ...
                entity.HasIndex(e => new { e.Id, e.Name, e.Phone, e.Images, e.Fanpage, e.Latitude, e.Longitude, e.OpeningDate, e.Maps, e.Ward, e.Parking, e.ParkingMap, e.Publish, e.IsSalonHoiQuan, e.IsDelete, e.DistrictId, e.CityId })
                    .HasName("_dta_index_Tbl_Salon_11_1069558123__K14_K25_K15_K4_K3_1_2_6_10_19_35_36_37_38_39_42_43");
